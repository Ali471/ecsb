	...
	<div class="container">
		<div class="dropdown">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
				<li><a href="#head" class="active">Profile</a></li>
				<li><a href="#about">Your Stores</a></li>
		...
		<div class="row">
			<div class="col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 text-center">	
				...
				<div class="rounded class="wow fadeInUp >
					...
					<img src="assets/screenshots/share.jpg"  alt="">
					
				</div>
				<h1 class="title">Muhammad Ali</h1><hr>
				<h2 class="subtitle">Creat Your Store Free And Sale Products </h2>

				<!-- Short introductory (optional) -->
				<h3 class="tagline">
					You can Creat Your Own Store And Use Our Build IN templates To Make Your Online Site.<br>
					So,Click Below Button to proceed......
				</h3>
				
				<!-- Nice place to describe your site in a sentence or two -->
				<p><a href="#newstore" class="btn btn-default btn-lg">Creat Store</a>
					<a href="#newstore" class="btn btn-default btn-lg">View Store</a>
				</p>
...
<section class="section" id="newstore">
	<div class="container">
		<h2 class="text-center title">Enter Your  Details</h2>
	</div>
</section>
